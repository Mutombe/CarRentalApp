...
class Chauffeur(models.Model):
    ...
    profile_photo = models.ImageField(upload_to="static/media/chauffeur_profiles", blank=False)
    ...
    ecocash_rate = models.DecimalField(default=Decimal("0.00"), max_digits=7, decimal_places=2)
