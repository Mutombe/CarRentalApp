...
from car_rental.settings import PAYNOW_INTEGRATION_ID, PAYNOW_INTEGRATION_KEY, PAYNOW_RETURN_URL, PAYNOW_RESULT_URL
    ...
    def get(self, request, pk):
        ...
        if rental.payment_method == 'Ecocash':
            ...
            try:
                ...
                return render(request, 'payment/failure_payment.html', {'error': str(e)})
        else:
            return render(request, 'payment/failure_payment.html', {'error': 'Invalid Payment Method'})
