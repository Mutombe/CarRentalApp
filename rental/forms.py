...
class RentalForm(forms.ModelForm):
    ...
    payment_method = forms.ChoiceField(choices=[('USD', 'USD'), ('Ecocash', 'Ecocash')], widget=forms.RadioSelect)
    ...
    class Meta:
        model = Rental
        fields = ['start_date', 'end_date', 'with_chauffeur','customer_destination', 'payment_method']